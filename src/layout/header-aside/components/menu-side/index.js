...
export default {
  name: 'yxb-layout-header-aside-menu-side',
  mixins: [
    menuMixin
  ],
  render(createElement) {
    return createElement('div', {
      attrs: { class: 'yxb-layout-header-aside-menu-side' }
    }, [
      ...
      ...this.menuAside.length === 0 && !this.asideCollapse ? [
        createElement('div', {
          attrs: { class: 'yxb-layout-header-aside-menu-empty', flex: 'dir:top main:center cross:center' }
        }, [
          createElement('yxb-icon', {
            props: { name: 'inbox' }
          }),
          createElement('span', {
          }, '暂无侧栏菜单')
