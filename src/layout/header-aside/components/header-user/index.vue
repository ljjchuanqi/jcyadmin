...
export default {
  ...
  methods: {
    ...
    getMessageUnread() {
      ...
      //     this.$store.commit('ldyxb/user/setMessage', res.data['total'])
      //   })
    },
    /**
     * @description 登出
