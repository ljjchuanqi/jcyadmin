...
import { getHistoryList } from '@/api/gzt/formmanage'
...
export default {
      ...
      this.$message.error(
        {
          ...
          duration: 2000,
          onClose() {
            that.$router.push({ name: 'gzt-formmanage-history' })
          }
        })
    }
  ...
  methods: {
    ...
    handleSubmit(form, isRestore = false) {
      ...
      // this.activeAcid
      form = Object.assign(form, { 'acid': this.activeAcid }, { 'mform_id': this.$route.query.id })
      this.loading = true
      getHistoryList({
        ...form,
