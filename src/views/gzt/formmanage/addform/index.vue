      ...
      >
        ...
        <el-row :gutter="10">
          <el-form-item label="首页地址">
            <el-input
              v-model.trim="formInline.home_url"
              placeholder="请输入首页地址"
              style="width: 250px;"
            ></el-input>
          </el-form-item>
        ...
        <el-row :gutter="10">
          <el-form-item label="返回地址标题">
            <el-input
              v-model.trim="formInline.return_text"
              placeholder="请输入返回地址标题"
              style="width: 250px;"
            ></el-input>
          </el-form-item>
        </el-row>
        <el-row :gutter="10">
          <el-form-item label="返回地址">
            <el-input
              v-model.trim="formInline.return_url"
              placeholder="请输入返回地址"
              style="width: 250px;"
            ></el-input>
          </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleFormSubmit() {
      ...
      this.formInline.is_admin = 0// 是否为管理员表单1-是0-否
          ...
          .then(res => {
            ...
            this.$message({
              ...
              onClose() {
                ...
                that.$router.push({ name: 'gzt-formmanage-list' })
              }
            })
          })
          .catch(() => {
