<template>
  <el-form
    ...
    <el-form-item
      ...
      prop="image_ext">
      <yxb-tab-edit v-model="imageExt" type="info" effect="plain"/>
    ...
    <el-form-item
      ...
      prop="file_ext">
      <yxb-tab-edit v-model="fileExt" type="info" effect="plain"/>
    ...
    <el-divider>检察院(本地上传)</el-divider>

    <el-form-item
      :label="form.site_url.description"
      prop="site_url">
      <el-input
        v-model="form.site_url.value"
        :placeholder="form.site_url.description"
        :clearable="true"/>
      <div class="help-block" v-html="form.site_url.help_text"></div>
    </el-form-item>
...
export default {
  components: {
    'yxbTabEdit': () => import('@/components/yxb-tab-edit')
  },
  data() {
    return {
      form: null,
