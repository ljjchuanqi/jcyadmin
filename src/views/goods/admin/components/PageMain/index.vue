      ...
      <el-tab-pane
        ...
        <el-table
          ...
          <el-table-column
            ...
            min-width="380">
            <template slot-scope="scope">
              <div class="goods-summary yxb-mb-5">
                <span class="yxb-mr">商品货号：{{scope.row.goods_code}}</span>
