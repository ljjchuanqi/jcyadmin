      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <el-popover
            ...
            <yxb-icon slot="reference" name="user-circle"/>
          </el-popover>
          {{scope.row.username}}
        </template>
      </el-table-column>
        ...
        <el-form-item
          ...
          <el-input
            ...
            <yxb-upload
              ...
              <el-button slot="control"><yxb-icon name="upload"/></el-button>
            </yxb-upload>
          </el-input>
        </el-form-item>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item
              ...
              <el-tooltip content="正数增加，负数减少" placement="top">
                <yxb-icon name="question" class="yxb-pl-5"/>
              </el-tooltip>
            </el-form-item>
          </el-col>
          ...
          <el-col :span="12">
            <el-form-item
              ...
              <el-tooltip content="正数增加，负数减少" placement="top">
                <yxb-icon name="question" class="yxb-ml-5"/>
              </el-tooltip>
            </el-form-item>
          </el-col>
        </el-row>
