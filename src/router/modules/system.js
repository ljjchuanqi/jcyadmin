...
export default {
  ...
  children: (pre => [
    ...
    {
      path: 'tablemanage/table',
      name: `${pre}tablemanage-table`,
      meta: { ...meta, cache: true, title: '数据模型' },
      component: () => import('@/views/system/tablemanage/table')
    },
    {
      path: 'tablemanage/addtable',
      name: `${pre}tablemanage-addtable`,
      meta: { ...meta, cache: true, title: '新增数据模型' },
      component: () => import('@/views/system/tablemanage/addtable')
    },
    {
      path: 'tablemanage/edittable',
      name: `${pre}tablemanage-edittable`,
      meta: { ...meta, cache: true, title: '编辑数据模型' },
      component: () => import('@/views/system/tablemanage/edittable')
    }
  ])('system-')
}
