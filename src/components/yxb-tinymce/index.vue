<template>
  <div style="width: 99.75%;">
    ...
    <yxb-upload ref="upload" type="slot" style="display: none" @confirm="_getUploadFileList"/>
    <yxb-storage ref="storage" style="display: none" @confirm="_getStorageFileList"/>
  </div>
</template>
...
import yxbUpload from '@/components/yxb-upload'
import yxbStorage from '@/components/yxb-storage'

export default {
  name: 'yxb-tinymce',
  components: {
    'yxbUpload': yxbUpload,
    'yxbStorage': yxbStorage
  },
  props: {
    // 外部v-model值
    value: {
