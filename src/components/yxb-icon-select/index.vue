<template>
  <span>
    <el-popover
      ...
      width="300"
      trigger="click">
      <el-row type="flex" justify="end" class="yxb-mb-10" v-if="clearable">
        <el-button type="danger" icon="el-icon-delete" size="mini" class="yxb-fr" @click="selectIcon()">清空</el-button>
      </el-row>
      <el-input
        v-model="searchText"
        :clearable="true"
